...
public class EmployeeService {
    ...
    public Page<EmployeeDto> findPage(Pageable pageable) {
        ...
        Page<EmployeeDto> page =
                employeeRepository.findAllWithDepartment(pageable)
                        .map(this::convertToDto);
    ...
    @Transactional(readOnly = true)
    public Page<EmployeeDto> searchPage(String name,
                                        Pageable pageable) {
        ...
        Page<EmployeeDto> dtoPage =
                employeeRepository.searchWithDepartment(
                        keyword,
                        pageable
                ).map(this::convertToDto);
    ...
    public Employee saveFromDto(EmployeeDto dto) {
        ...
        employee.setDepartment(
                resolveDepartment(dto.getDepartmentId())
        );
